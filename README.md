<div align="center">
    <h1><b>Zandra</b></h1>
    <h4>A minimal Linux distribution</h4>
</div>

> [!NOTE]
> Zandra is not under active development anymore. Security vulnerabilities
> **definitely** exist in certain packages and some may not even build anymore.
...
- [Installing Packages Within Zandra](#installing-packages-within-zandra)

## Overview

Zandra is a minimal Linux distribution forked from
[morpheus linux](http://morpheus.2f30.org). It aims to be simple, small, and
efficient.

## Prerequisites

- A x86_64-linux-musl toolchain (GNU Binutils, GCC, linux-headers,
